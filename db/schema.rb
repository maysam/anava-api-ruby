...
ActiveRecord::Schema[8.1].define(version: 20_260_920_120_000) do
  create_table 'panel_magic_links', force: :cascade do |t|
    ...
    t.index ['expires_at'], name: 'index_panel_magic_links_on_expires_at'
    t.index ['token_digest'], name: 'index_panel_magic_links_on_token_digest', unique: true
    t.index ['user_id'], name: 'index_panel_magic_links_on_user_id'
  end
  ...
  create_table 'recordings', force: :cascade do |t|
    ...
    t.index %w[user_id date], name: 'index_recordings_on_user_id_and_date'
